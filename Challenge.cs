...
namespace Quest
{
    ...
    public class Challenge
    {
        ...
        public Challenge(string challengeText, int challengeCorrectAnswer, int challengeAwesomenessChange)
        {
            _text = challengeText;
            _correctAnswer = challengeCorrectAnswer;
            _awesomenessChange = challengeAwesomenessChange;
        }
